...
const ExpensePage = () => {
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      await handleApiRequest('post', '/api/transaction/add', payload);
  ...
  const handleEditTransaction = async () => {
    ...
    try {
      ...
      await handleApiRequest('put', `/api/transaction/update/${editingId}`, payload);
      setEditingId(null);
    } catch (err) {
      // Error handled in handleApiRequest
    }
  ...
  const handleDeleteTransaction = async (id) => {
    ...
    await handleApiRequest('delete', `/api/transaction/delete/${id}`);
  };
