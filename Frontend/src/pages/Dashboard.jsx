...
const Dashboard = () => {
  ...
  const fetchDashboardOverview = async () => {
    try {
        ...
        if (timeFrame === "monthly") {
          ...
          const maxValues = {
            income: Math.max(monthlyIncome, 1),
            expenses: Math.max(monthlyIncome, 1),  
            savings: Math.max(monthlyIncome, 1),
          };
  ...
  const handleAddTransaction = async () => {
    ...
    try {
        setLoading(true);
        await axios.post(`${API_BASE}/api/transaction/add`, {
            ...payload,
        ...
        <div className={dashboardStyles.container}>
            ...
            <div className={dashboardStyles.headerContainer}>
                <div className={dashboardStyles.headerContent}>
                    <div>
                        <h1 className={dashboardStyles.headerTitle}>Your Money Dashboard</h1>
