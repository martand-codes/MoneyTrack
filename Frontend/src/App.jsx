...
// To scroll to Top When Page is Reloded
...
const App = () => {
  ...
  const navigate = useNavigate();  // From Our react-router-dom package
  ...
  // To update user data both in storage and state
      ...
      try {
        ...
        if(storedToken) {
          try {
            ...
            console.warn("Could Not Fetch Profile with This Stored Token", fetchErr);
            clearAuth();
          }
        }
      } catch (err) {
          ...
          try {
            setTransactions(getTransactionFromStorage());
              ...
              console.error("Error Loading in Transactions: ", txErr);
          }
        }
    })();
  }, []);
  ...
  const handlleSignup = (userData, remember = false, tokenFromApi = null) => {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/signup" element={<Signup onSignup={handlleSignup} />} />
