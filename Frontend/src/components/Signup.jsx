...
const Signup = ({API_URL = import.meta.env.VITE_API_BASE, onSignup}) => {
        ...
        <div className={signupStyles.pageContainer}>
            <div className={signupStyles.cardContainer}>
                <div className={signupStyles.header}>
                    ...
                    <h1 className={signupStyles.headerTitle}>Create Your Account</h1>
                    <p className={signupStyles.headerSubtitle}>
                        Join MoneyTrack to Fix Your Finances
                    </p>
                </div>
