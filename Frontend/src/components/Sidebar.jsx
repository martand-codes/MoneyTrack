...
import { sidebarStyles, cn } from "../assets/dummyStyles"; // cn will help as a boolean
...
const Sidebar = ({user, isCollapsed, setIsCollapsed}) => {
    ...
    // To Prevent OverFlow for Mobile View
    ...
    // If we Click Outside the Sidebar
                ...
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    <div className={cn(
                        ...
                        <Link className={cn(
                            ...
                            to="https://www.linkedin.com/in/martand-prakhar-a04904315/"
                        >
